  ...
  return (
    <div>
      <ul id='skill-sets'>
        ...
        <li className='skill-set-li'> 
          <span className='skill-num hover-underline-animation'>008.</span>
          <span className='skill-titles'>SQL</span>
        </li>
        <li className='skill-set-li'> 
          <span className='skill-num hover-underline-animation'>009.</span>
          <span className='skill-titles'>PSQL</span>
        </li>
        <li className='skill-set-li'> 
          <span className='skill-num hover-underline-animation'>010.</span>
          <span className='skill-titles'>MongoDB</span>
        </li>
      </ul>
    </div>
  )
